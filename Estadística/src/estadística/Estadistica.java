...
public class Estadistica extends JFrame implements ActionListener{
                ...
                public Estadistica(){
                               ...
                               panelcalculos=new JPanel(new GridLayout(9,9,10,10));
                               ...
                               lblcovarianza=new JLabel("Covarianza");
                               ...
                               txtcovarianza=new JTextField(15);
                               ...
                               panelcalculos.add(lblcovarianza);
                               panelcalculos.add(txtcovarianza);
